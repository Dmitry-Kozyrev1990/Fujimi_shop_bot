...
conversation_after_start = "Привет!\n" \
                           "Добро пожаловать в Fujimishop!\n" \
                           "Фото - и видеоаксессуары для профессионалов и начинающих фотографов.\n" \
                           "Это 🅱️ <b>Бета</b> версия нашего торгового бота.\n" \
                           "Если нашли баг - сообщите тут: diko.group@mail.ru"
...
# User menu: cash
menu_cash = "💵 Оплата при получении"
...
ask_order_notes = "Оставить заметку к этом заказу?\n" \
                  "Вы можете указать необходимое количество товара, мы также принимаем оптовые заказы\n" \
...
payment_cash = "Вы можете оплатить заказ при получении наличными или картой\n" \
               "Мы доставляем товары Почтой России или СДЭК, также Boxberry\n" \
               "При выборе оплата наличными, перешлите сообщение заказа или товара админу @dmitrykozyrev\n" \
               "Далее нажмите кнопку отмена, Ваш заказ будет обработан в ручном режиме менеджером\n" \
               "Расчёты стоимости доставки:\n" \
               "<a>https://www.cdek.ru/ru/calculate\n<a>" \
               "<a>https://www.pochta.ru/parcels\n<a>" \
               "<a>https://boxberry.ru/find_an_office\n<a>" \
               "<b>{user_cash_id}</b>"
...
bot_info = 'Этот бот использует <a href="https://github.com/Dmitry-Kozyrev1990/Fujimi_shop_bot">kozyrev</a>,' \
           'фреймворк переработан @dmitrykozyrev для платежей Телеграм и выпущен под лицензией' \
